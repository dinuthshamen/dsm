        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    ...
                    <h1> <i class="fa fa-print" style="font-size:30px;"></i> List: Completed Invoice </h1>   
                    </div>
...
<?php   // generating Main Categories
 $countrow ==0;
$query = mysqli_query($con,"select a.invoice_no,a.date_time,a.is_done,a.job_id,a.amount,a.discount,e.full_name,a.is_print,a.is_cancelled,b.ve_no,c.Vowner,d.title,d.fname,d.lname,d.address1,d.address2,d.address3,d.email
...
on a.user_name = e.user_name WHERE a.is_print=1 AND a.is_done=1");
...
?>
 <tr>
                            ...
                            echo '<center><button type="button" class="btn btn-warning btn-xs">Yes</button></center>';
                                    ...
                                    <td>  
                                    <a href="reports/invoice_report.php?inv_no=<?php echo $row['invoice_no']?>"  target='blank' class="btn btn-info" type="button">Print <span class="glyphicon glyphicon-print"> </a>
                                   </td>
