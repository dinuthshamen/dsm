        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    ...
                    <h1> <i class="fa fa-print" style="font-size:30px;"></i> List: Completed Jobs </h1>   
                    </div>
...
<?php   // generating Main Categories
 $countrow ==0;
$query = mysqli_query($con,"select job_id,date_time,ve_no,type_name,Is_print,description,service_millage,c.status,button,service_millage from service_job as a inner join job_status as c on c.status_id = a.status inner join service_types as b on b.type_id = a.service_type Where closed =1 ORDER BY date_time DESC ");
